...
const translations = {
  ja: {
    ...
    "admin.login.subtitle": "サイトのコンテンツとデータを管理します。",
    "admin.header.title": "イケメン名鑑 管理画面",
    "admin.header.logout": "ログアウト",
    "admin.dashboard": "ダッシュボード",
    "admin.dashboard.tagline": "コンテンツ・データの管理",
    "admin.dashboard.intro": "作業する項目を選んでください。",
    "admin.dashboard.section.content": "コンテンツ",
    "admin.dashboard.section.structure": "分類・問い合わせ",
  ...
  en: {
    ...
    "admin.login.subtitle": "Sign in to manage site content and data.",
    "admin.header.title": "Ikemen Directory Admin",
    "admin.header.logout": "Log Out",
    "admin.dashboard": "Dashboard",
    "admin.dashboard.tagline": "Content and data management",
    "admin.dashboard.intro": "Choose a section to work on.",
    "admin.dashboard.section.content": "Content",
    "admin.dashboard.section.structure": "Taxonomy & inbound",
