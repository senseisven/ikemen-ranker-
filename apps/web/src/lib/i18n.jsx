...
const translations = {
  ja: {
    ...
    "home.noData.banner": "ランキングデータがありません。カテゴリと人物を追加すると表示されます。",
    ...
    "home.noData.instructions": "からログインしてデータを登録してください。",
    ...
    "home.minimal.headingLabel": "ピックアップ",
    "home.minimal.headingPicks": "今週の注目",
    "home.minimal.headingRankings": "ランキング",
    ...
    "home.news.label": "ニュース",
    "home.news.title": "最新記事",
    "home.news.readMore": "記事を読む →",
    "home.news.viewAll": "すべての記事を見る →",
    "home.news.empty": "まだ記事がありません。",
    ...
    "admin.art.body": "本文",
    "admin.art.featuredImage": "アイキャッチ画像",
  ...
  en: {
    ...
    "home.noData.banner": "No ranking data available. Add categories and people to display rankings.",
    ...
    "home.noData.instructions": " — log in and register data.",
    ...
    "home.minimal.headingLabel": "Featured",
    "home.minimal.headingPicks": "Weekly picks",
    "home.minimal.headingRankings": "Rankings",
    ...
    "admin.art.body": "Body",
    "admin.art.featuredImage": "Featured Image",
